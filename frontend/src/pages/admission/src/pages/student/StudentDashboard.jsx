            ...
            const printHTML = `
                ...
                <head>
                    ...
                    <style>
                        ...
                        * { margin: 0; padding: 0; box-sizing: border-box; -webkit-print-color-adjust: exact !important; print-color-adjust: exact !important; }
                        body { font-family: 'Times New Roman', Times, serif; background: white; padding: 10px; color: #000; }
                        .application-form { width: 100%; max-width: 100%; margin: 0 auto; background: white; }
                        ...
                        @media print { .watermark, .confirmed-stamp { position: fixed; } }
                ...
                <body>
                    ...
                    <div class="application-form">
                        ...
                        <div class="status-confirmed">✅ ADMISSION CONFIRMED </div>
