...
const SubmittedDashboard = ({ stepStatus, applicationStatus, timeline, navigate }) => {
    ...
    const getStatusMeta = (status) => {
        switch (status) {
            ...
            case 'ENROLLED':
            case 'USN_ASSIGNED':
                return { label: 'USN Assigned', icon: Award, color: 'text-purple-600', bg: 'bg-purple-100', desc: 'Your final VTU USN has been assigned. You are now fully enrolled in the university.' };
            case 'REJECTED':
